...
#ifndef _UNCAUGHT_EXCEPTIONS_H_
#define _UNCAUGHT_EXCEPTIONS_H_

#include <exception>

#if !defined(FORCE_EXCEPTION_COUNT_USE_STD) && \
...
#elif defined(FORCE_EXCEPTION_COUNT_USE_STD) || \
