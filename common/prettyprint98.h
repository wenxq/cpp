...
#ifndef _PRETTY_PRINT98_H_
#define _PRETTY_PRINT98_H_
...
inline std::basic_ostream<TChar, TCharTraits> & operator<<(std::basic_ostream<TChar, TCharTraits> & s, const pretty_print::custom_delims<TChar, Delims> & p)
{
...
#define TUPLE_ARGS T0, T1, T2, T3, T4, T5, T6, T7
