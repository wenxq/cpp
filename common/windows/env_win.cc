...
#include "windows/env_win.h"
#include "windows/win_thread.h"
#include <algorithm>
#include <ctime>
#include <thread>
...
#include "port.h"
#include "dirent.h"
#include "windows/win_logger.h"
#include "windows/io_win.h"
                           ...
                           std::shared_ptr<Logger>* result)
{
    ...
    HANDLE hFile = 0;
    {
        hFile = CreateFileA(
                    ...
                    FILE_SHARE_READ | FILE_SHARE_DELETE,  // In log files are
