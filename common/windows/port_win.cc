...
#pragma comment(linker, "/INCLUDE:p_init_jemalloc")
...
#pragma const_seg(".CRT$XCT")
    extern const CRT_Startup_Routine p_init_jemalloc;
    const CRT_Startup_Routine p_init_jemalloc =
        port::InitializeJemalloc;
#pragma const_seg()
...
#pragma comment(linker, "/INCLUDE:_p_init_jemalloc")

#pragma section(".CRT$XCT", read)
    JEMALLOC_SECTION(".CRT$XCT") JEMALLOC_ATTR(used) static const void(
        WINAPI* p_init_jemalloc)(void) = port::InitializeJemalloc;
